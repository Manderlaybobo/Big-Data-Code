# -*- coding: utf-8 -*-
"""
Created on Tue Aug  8 14:24:54 2023
...
# 构建堆叠模型
stacking_model = StackingClassifier(estimators=[('rf1', rf_model1), ('rf2', rf_model2), ('dt', dt_model)], final_estimator=RandomForestClassifier(n_estimators=100, random_state=42))
